package com.anan.document.modules.sys.user.service;
...
import com.anan.document.modules.sys.user.dto.request.MobileLoginReqDTO;
import com.anan.document.modules.sys.user.dto.request.MobileRegReqDTO;
import com.anan.document.modules.sys.user.dto.request.ResetPassReqDTO;
import com.anan.document.modules.sys.user.dto.request.SysUserLoginReqDTO;
import com.anan.document.modules.sys.user.dto.request.SysUserPassReqDTO;
import com.anan.document.modules.sys.user.dto.request.SysUserQueryReqDTO;
import com.anan.document.modules.sys.user.dto.request.SysUserSaveReqDTO;
import com.anan.document.modules.sys.user.dto.request.UserDeptReqDTO;
...
public interface SysUserService extends IService<SysUser> {
    ...
    IPage<SysUser> getUserPage(PagingReqDTO<SysUserQueryReqDTO> reqDTO);
