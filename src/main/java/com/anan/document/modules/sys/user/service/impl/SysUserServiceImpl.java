...
import com.anan.document.ability.captcha.service.CaptchaService;
import com.anan.document.ability.redis.service.RedisService;
import com.anan.document.ability.shiro.jwt.JwtUtils;
import com.anan.document.config.BaseConfig;
import com.anan.document.modules.sys.depart.service.SysDepartService;
import com.anan.document.modules.sys.log.service.SysLogActiveService;
import com.anan.document.modules.sys.user.dto.SysUserDTO;
import com.anan.document.modules.sys.user.dto.request.*;
import com.anan.document.modules.sys.user.dto.response.SysUserLoginDTO;
import com.anan.document.modules.sys.user.dto.response.UserExportDTO;
import com.anan.document.modules.sys.user.dto.response.UserListRespDTO;
import com.anan.document.modules.sys.user.entity.SysRole;
import com.anan.document.modules.sys.user.entity.SysUser;
import com.anan.document.modules.sys.user.entity.SysUserBind;
import com.anan.document.modules.sys.user.mapper.SysUserMapper;
import com.anan.document.modules.sys.user.service.SysUserBindService;
import com.anan.document.modules.sys.user.service.SysUserRoleService;
import com.anan.document.modules.sys.user.service.SysUserService;
import com.anan.document.modules.sys.user.utils.SignUtils;
...
import com.anan.document.utils.CacheKey;
import com.yf.document1.modules.sys.user.dto.request.*;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    @Override
    public IPage<SysUser> getUserPage(PagingReqDTO<SysUserQueryReqDTO> reqDTO) {
        Page page = reqDTO.toPage();
        page(page);
        List<SysUser> records = page.getRecords();
        ArrayList<SysUser> sysUsers = new ArrayList<>();
        records.stream().forEach(record -> sysUsers.add(new SysUser(record.getId(), record.getUserName())));
